...
---
## Video Demo
Watch this video to learn how to give a FIPS demo.

<video src="https://chainguard.wistia.com/medias/tdq63xcqhe" controls="controls" style="max-width: 730px;">
</video>
...
10. Run the new image: `docker run -ti --rm -e PORT=8080 -p 8080:8080python-fips-demo-sha256:latest`
